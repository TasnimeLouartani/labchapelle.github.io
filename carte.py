...
arena_txt = '<h4>Adidas Arena</h4><img src="C:/Users/louartani/Documents/nc/arena.jpg" width="200"><p>Lieu de référence des cultures urbaines où fait se rencontrer musique, sport, culture et lifestyle pour tous.</p>'
markers_travaux(arena_txt,arena, travaux_markers,m)
condorcet_txt = '<h4>Campus Condorcet</h4><img src="C:/Users/louartani/Documents/nc/condorcet.jpg" width="200"><p>Un campus international pour répondre aux défis pédagogiques, scientifiques et numériques du XXIe siècle.</p>'
markers_travaux(condorcet_txt, campus, travaux_markers,m)
charbon_txt = '<h4>Chapelle Charbon</h4><img src="C:/Users/louartani/Documents/nc/chapelle_charbon.jpg" width="200"><p>Transformation d’un ancien site logistique ferroviaire du 18e arrondissement pour créer un grand parc bordé d’un ensemble résidentiel qui vient achever le quartier Évangile.</p>'
...
rue_txt = '<h4>Végétalisation de la rue de la Chapelle</h4><img src="C:/Users/louartani/Documents/nc/rue.jpg" width="200"><p>Cet axe majeur du quartier va être métamorphosé en une vaste promenade. Aménagement de pistes cyclables, réduction de la place de la voiture, végétalisation, nouvel éclairage public...</p>'
